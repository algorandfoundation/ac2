 ...
 *
 * Lives alongside the signaling interfaces because `Ac2PairedChannel.peer.did`
 * (see `./index.ts`) is exactly where a channel provider surfaces a verified
 * peer identity — a Liquid Auth bringup, for instance, normalizes the
 * wallet's linked account into this canonical form before returning it.
 */
